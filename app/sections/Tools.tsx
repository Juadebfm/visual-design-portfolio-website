...
import {
    ...
    SiSupabase,
    SiAdobephotoshop, SiFirebase, SiMongodb, SiCplusplus, SiFigma,SiCanva, SiFramer, SiGit,SiHtml5,
    SiGithub, SiCss3,SiBootstrap,SiTailwindcss,SiSanity,
    SiGooglechrome, SiGooglefonts,SiNodedotjs,
    SiIntellijidea, SiJavascript, SiCpanel, SiWordpress,
    SiNeovim, SiNextdotjs, SiReact, SiAsana, SiTypescript, SiWebstorm, SiGoogleanalytics
} from "react-icons/si";
